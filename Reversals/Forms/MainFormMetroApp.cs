...
//
        ...
        private void uiStrategyOptomizationParameters_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            ...
            _optParameterssChanging = new ParametersChangingNotifier
                {
                    optParameters = OptimizationParameters.Instance,
                    ParameterName = uiStrategy_dataGridViewOptomizationParameters.Rows[e.RowIndex].Cells[0].Value.ToString(),
                    DefaultValue = uiStrategy_dataGridViewOptomizationParameters.Rows[e.RowIndex].Cells[1].Value,
                    MinValue = uiStrategy_dataGridViewOptomizationParameters.Rows[e.RowIndex].Cells[2].Value,
                    MaxValue = uiStrategy_dataGridViewOptomizationParameters.Rows[e.RowIndex].Cells[3].Value,
                    Step = uiStrategy_dataGridViewOptomizationParameters.Rows[e.RowIndex].Cells[4].Value
                };*/
        }
